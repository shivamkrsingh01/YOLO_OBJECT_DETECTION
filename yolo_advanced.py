...
INITIAL_PIXEL_PER_METER = 234.0  # calibrate this for your camera/scene
DISTANCE_SMOOTH_WINDOW = 5       # moving average window per object
TRACKER_MAX_DISTANCE = 80        # max pixel distance to consider same object (matching)
FPS_SMOOTH = 5                   # smoothing window for FPS display
# ----------------------------------------
...
class SimpleTracker:
    ...
    def update(self, centroids):
        ...
        for _ in range(min(E, N)):
            ...
            # If all are inf, nanargmin will raise; handle by checking
